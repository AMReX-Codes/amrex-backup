module eb_advection_module
  ...
  implicit none
  private
  public :: hyp_mol_gam_eb_3d, hyp_mol_gam_eb_sp_3d
...
contains
  ...
  subroutine hyp_mol_gam_eb_sp_3d(q, qd_lo, qd_hi, &
                     lo, hi, dx, &
                     flux1, fd1_lo, fd1_hi, &
                     flux2, fd2_lo, fd2_hi, &
                     flux3, fd3_lo, fd3_hi, &
    ...
    use cns_module, only : urho, umx, umy, umz, ueden, ueint, utemp, nvar, &
         qrho,qu,qv,qw,qp,qc,qeint,qtemp,qvar, smallp, smallr
    use cns_physics_module, only : gamma
    use ebslope_sp_module, only : ebslopex_sp , ebslopey_sp, ebslopez_sp
    use ebslope_module, only : ebslopex, ebslopey, ebslopez
    use riemann_module, only : analriem
    ...
    real(rt), pointer, contiguous :: dqt(:,:,:,:)
