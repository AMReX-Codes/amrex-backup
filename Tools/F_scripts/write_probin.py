            ...
            if keyword in ["declarationsA", "declarationsB"]:
                ...
                for p in pm:
                    ...
                    if managed:
                        ...
                        if p.type == "real":
                            decl_string = "{}real (kind=rt), save, public :: {} = {}\n"

                        elif p.type == "character":
                            decl_string = "{}character (len=256), save, public :: {} = {}\n"

                        elif p.type == "integer":
                            decl_string = "{}integer, save, public :: {} = {}\n"

                        elif p.type == "logical":
                            decl_string = "{}logical, save, public :: {} = {}\n"

                        else:
                            print("write_probin.py: invalid datatype for variable {}".format(p.var))

                        fout.write(decl_string.format(indent, p.var, p.value))
                        fout.write("{}!$acc declare create({})\n".format(indent, p.var))
