                         ...
                         const FArrayBox& volfrac)
{
    ...
    amrex_eb_flux_reg_crseadd_v(BL_TO_FORTRAN_BOX(bx),
                                BL_TO_FORTRAN_ANYD(fab),
                                BL_TO_FORTRAN_ANYD(amrflag),
                                AMREX_D_DECL(BL_TO_FORTRAN_ANYD(*flux[0]),
                                             BL_TO_FORTRAN_ANYD(*flux[1]),
        ...
        {
            {
                ...
                {
                    cvol.resize(lobx_is);
                    amrex_eb_flux_reg_fineadd_v(BL_TO_FORTRAN_BOX(lobx_is),
                                                BL_TO_FORTRAN_ANYD(*cfp),
                                                BL_TO_FORTRAN_ANYD(*flux[idim]),
                                                BL_TO_FORTRAN_ANYD(cvol),
                                                BL_TO_FORTRAN_ANYD(volfrac),
            ...
            }
            {
                ...
                {
                    cvol.resize(hibx_is);
                    amrex_eb_flux_reg_fineadd_v(BL_TO_FORTRAN_BOX(hibx_is),
                                                BL_TO_FORTRAN_ANYD(*cfp),
                                                BL_TO_FORTRAN_ANYD(*flux[idim]),
                                                BL_TO_FORTRAN_ANYD(cvol),
                                                BL_TO_FORTRAN_ANYD(volfrac),
