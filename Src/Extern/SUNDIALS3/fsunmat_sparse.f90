...
module fsunmat_sparse_mod

  use, intrinsic :: iso_c_binding, only : c_int

  integer(c_int), parameter :: CSC_MAT = 1
  integer(c_int), parameter :: CSR_MAT = 2
  ...
  interface
     ...
     type(c_ptr) function FSUNSparseMatrix_Realloc(A) &
     ...
     type(c_ptr) function FSUNSparseMatrix_Reallocate(A, NNZ) &
     ...
     ! -----------------------------------------------------------------
     ! NOT INTERFACED SUNMatGetID_Sparse
     ! -----------------------------------------------------------------
